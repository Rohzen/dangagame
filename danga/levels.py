...
class Level_02(Level):
    ...
    def __init__(self, player):
        ...
        # Array with type of platform, and x, y location of the platform.
        level = [ [platforms.TRS_PLATFORM, 50, 500],
                  [platforms.TRS_PLATFORM, 50, 400],
                  [platforms.STD_PLATFORM, 500, 550],
                  [platforms.STD_PLATFORM, 570, 550],
                  [platforms.STD_PLATFORM, 640, 550],
                  [platforms.STD_PLATFORM, 800, 400],
                  [platforms.STD_PLATFORM, 870, 400],
                  [platforms.STD_PLATFORM, 940, 400],
                  [platforms.STD_PLATFORM, 1000, 500],
